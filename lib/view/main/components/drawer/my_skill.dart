  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.6, title: 'Responsive Design',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'Clean Architecture',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'HTML',image: 'assets/icons/html1.png'),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'CSS',image: 'assets/icons/CSS-Logo.png'),
      ],);
  }
}
